...
export const LoginView = () => {
    ...
    return (
        <div className="min-h-screen flex bg-sky-bg">
            {/* Left Side - Marketing */}
            <div className="hidden lg:flex w-1/2 bg-sky-accent relative flex-col justify-between p-12 text-white overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-sky-accent/90 to-indigo-900/90"></div>

                <div className="relative z-10">
                    <div className="flex items-center gap-3 text-2xl font-bold mb-6">
                        <ShieldAlert className="w-8 h-8" /> AI Wise Recovery
                    </div>
                    <h1 className="text-4xl font-bold leading-tight mb-4">
                        Thẩm định Thông minh,<br />Xử lý Nhanh chóng
                    </h1>
                    <p className="text-lg text-indigo-100 max-w-lg mb-6">
                    ...
                    <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20">
                        <p className="text-sm text-indigo-100">
                            💡 <span className="font-semibold text-white">Ý tưởng:</span> NPLR South PPM - thinh.hoangnhu
                        </p>
                    </div>
                </div>

                <div className="relative z-10 flex gap-4 text-sm font-medium text-indigo-200">
                    <span>© 2025 AI Wise Recovery - NPLR South PPM - thinh.hoangnhu</span>
                </div>
            </div>
                ...
                <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-right-8 duration-500">
                    <div className="text-center lg:text-left">
                        <div className="lg:hidden flex justify-center mb-4">
                            <ShieldAlert className="w-10 h-10 text-sky-accent" />
                        </div>
                        <h2 className="text-3xl font-bold text-sky-text mt-4">
                            {isLogin ? 'Chào mừng trở lại!' : 'Tạo tài khoản mới'}
                        </h2>
                        <p className="text-sky-text-secondary mt-2">
                            {isLogin ? 'Vui lòng đăng nhập để tiếp tục công việc.' : 'Đăng ký miễn phí và bắt đầu sử dụng ngay.'}
                        </p>
                    </div>
